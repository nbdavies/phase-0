...
// There was one error message that I misread. It said that Terah's spouse's spouse property should point back to Terah. I tried to make Terah her own spouse which is valid JavaScript but failed the test. So I set Adam's spouse property to Terah and that did it.
//
// How difficult was it to add and delete properties outside of the object itself?
// The "delete" keyword I had to look up. Otherwise I thought it was straightforward.

// What did you learn about manipulating objects in this challenge?
// It's pretty easy, and you don't even need to create a bunch of accessor methods!
